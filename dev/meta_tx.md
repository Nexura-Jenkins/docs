...
https://github.com/NEXURACHAIN/metatx-Java-demo
...
NEXURACHAIN officially provides a meta transaction service with a fee subsidy based on the caller's `BTC` holdings.
...
https://meta-mainnet.XURAlveblockchain.io
