# Contract
`NEXURACHAIN` uses `EVM` for contract execution.See [Solidity](https://docs.soliditylang.org/en/v0.7.1/#) for detail.
...
module.exports = {
  networks: {
    ...
    mainnet: {
      provider: () => new HDWalletProvider(mnemonic, 'https://rpc.nexurachain.io'),
      network_id: 3424
    }
  },
